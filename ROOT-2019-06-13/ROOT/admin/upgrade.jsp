...
<script type="text/javascript" src="${cacheFile['/admin/js/set_update.js']}" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-90" data-genuitec-path="/zrlog/src/main/webapp/admin/upgrade.jsp" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc2-91" data-genuitec-path="/zrlog/src/main/webapp/admin/upgrade.jsp"></script>
