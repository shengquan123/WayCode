...
<div class="page-header" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-63" data-genuitec-path="/zrlog/src/main/webapp/admin/index.jsp" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc2-64" data-genuitec-path="/zrlog/src/main/webapp/admin/index.jsp">
<h3>
${_res.dashboard}
</h3>
</div><!-- /.page-header -->
