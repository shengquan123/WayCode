...
<link rel="stylesheet" href="${cacheFile['/assets/css/ui.jqgrid.css']}"  data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-48" data-genuitec-path="/zrlog/src/main/webapp/admin/article.jsp" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc2-48" data-genuitec-path="/zrlog/src/main/webapp/admin/article.jsp"/>
