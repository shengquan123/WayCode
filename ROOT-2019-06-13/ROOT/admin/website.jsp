...
<script type="text/javascript" src="${cacheFile['/admin/js/set_update.js']}" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-92" data-genuitec-path="/zrlog/src/main/webapp/admin/website.jsp" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc2-93" data-genuitec-path="/zrlog/src/main/webapp/admin/website.jsp"></script>
