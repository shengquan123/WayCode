...
<script type="text/javascript" src="${cacheFile['/admin/js/set_update.js']}" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-53" data-genuitec-path="/zrlog/src/main/webapp/admin/do_upgrade.jsp" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc2-54" data-genuitec-path="/zrlog/src/main/webapp/admin/do_upgrade.jsp"></script>
