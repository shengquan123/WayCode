...
<script src="${cacheFile['/assets/js/jquery.liteuploader.min.js']}" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-87" data-genuitec-path="/zrlog/src/main/webapp/admin/template.jsp" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc2-88" data-genuitec-path="/zrlog/src/main/webapp/admin/template.jsp"></script>
