...
public interface WayAccessoryModelUserMapper extends BaseMapper<WayAccessoryModelUser> {
	// 获取用户信息
	public List<WayAccessoryModelUser> selectWayAccessoryModelUserByPhone(@Param("phone") String phoneOrMail,
			@Param("status") int status);

	public List<WayAccessoryModelUser> selectWayAccessoryModelUserByMail(@Param("mail") String phoneOrMail,
			@Param("status") int status);
	...
	public WayAccessoryModelUser selectOneUserTest();
