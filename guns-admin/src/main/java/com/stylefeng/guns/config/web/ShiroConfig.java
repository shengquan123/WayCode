...
public class ShiroConfig {
    ...
    public DefaultWebSecurityManager securityManager(CookieRememberMeManager rememberMeManager,
    		...
    		@Qualifier("myRetryLimitCredentialsMatcher") MyRetryLimitCredentialsMatcher matcher) {
    ...
    public ShiroDbRealm myShiroRealm(MyRetryLimitCredentialsMatcher matcher){
    ...
    public ShiroFilterFactoryBean shiroFilter(DefaultWebSecurityManager securityManager) {
        ...
        hashMap.put("/startLogin", "anon");
        hashMap.put("/finishLogin", "anon");
        hashMap.put("/fidorest/app/enviroment", "anon");
