...
import com.stylefeng.guns.config.properties.Fido2RelyPartyProperties;
...
public class MybatisPlusConfig {
    ...
    @Autowired
    Fido2RelyPartyProperties fido2RelyPartyProperties;
    ...
    private DruidDataSource bizDataSource() {
        ...
        fido2RelyPartyProperties.config(dataSource);
        return dataSource;
    }
