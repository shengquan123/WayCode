...
public class ConstantFactory implements IConstantFactory {
    ...
    /**
     * 获取软件类型名称(软件类型  1:客户端App-SAFE,2:客户端App-NORMAL,3:设备固件-SAFE,4:设备固件-NORMAL1,5:设备固件-NORMAL3)
     * add by shengquan
     */
    public String getSoftName(Integer type) {
    	return getDictsByName("软件类型", type);
    }

    /**
     * 应用、设备是否可用(0:可用, 1:不可用)
     */
    public String getStatus(Integer status) {
    	return getDictsByName("是否可用", status);
    }

    /**
     * 设备是否损坏(0:正常, 1:损坏)
     */
    public String getCompromised(Integer compromised) {
    	return getDictsByName("是否损坏", compromised);
    }
    /**
     * 获取性别名称
     */
